...
'use strict';
(function () {
  /* №№№№№№№№№№№№№№№№№№№№№№№№№№№ Работающий вариант для поля аватара ВАРИАНТ 1. */
  ...
  // var getFileChoice = function () { /* Функция которая подставит выбранный пользователем файл изображения из поля выбора в место отображения картинки с заданными условиями. */
  //   var file = fileAvatar.files[0]; /* Приравниваю значение file к значению файла который выбран в поле(Данное свойство всегда выглядит как массив.) */
  ...
  // var onFileChoice = function () {
  //   getFileChoice();
  // };

  // fileAvatar.addEventListener('change', onFileChoice);

  /* №№№№№№№№№№№№№№№№№№№ КОНЕЦ ВАРИАНТА 1*/


  /* №№№№№№№№№№№№№№№№№№№№№№№ ВАРИАНТ 2 ПОЛЕ ФОТОГРАФИЙ ЖИЛЬЯ C изображением в фон. */
  ...
  // var getFileChoiceUpload = function () { /* Функция которая подставит выбранный пользователем файл изображения из поля выбора в место отображения картинки с заданными условиями. */
  //   var file = fileGallery.files[0]; /* Приравниваю значение file к значению файла который выбран в поле(Данное свойство всегда выглядит как массив.) */
  //   var fileName = file.name.toLowerCase(); /* Трансформирую имя файла для однотипного его восприятия. Приведен к строковым/маленьким.  */
  //   var matches = FILE_TYPES.some(function (it) { /* Проверка оканчивает ли имя файла на заданный тип. it он же ending. some это метод который будет вызван на каждый элемент массива FILE_TYPES и если строка оканчивается на переданую подстроку то тогда, если хоть один из вариантов константы(окончаний) подойдет/будет равен окончанию имени файла то он вернет true */
  //     return fileName.endsWith(it); /* Проверяет на соответствие заданным константам. */
  //   });
  ...
  //       // previewUpload.src = reader.result; /* Передаю значения в картинку/в атрибут  результат который будет получен при наступлении события load которое в свою очередь будет запущено reader.readAsDataURL(file); */
  //       previewUpload.style.backgroundImage/* ['background-image'] */ = 'url' + '(' + reader.result + ')'; /* Передаю значения в картинку/в атрибут  результат который будет получен при наступлении события load которое в свою очередь будет запущено reader.readAsDataURL(file); */
  //       previewUpload.style.backgroundSize/* ['background-size'] */ = '100%'; /* Передаю значения в картинку/в атрибут  результат который будет получен при наступлении события load которое в свою очередь будет запущено reader.readAsDataURL(file); */
  //     };
  ...
  // var onfileGallery = function () {
  //   getFileChoiceUpload();
  // };

  // fileGallery.addEventListener('change', onfileGallery);


  // ###########################################  ВАРИАНТ 2 КОНЕЦ   ######################################


  // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  ВАРИАНТ 3  НАЧАЛО ПОЛЕ ФОТОГРАФИЙ ЖИЛЬЯ C изображением в img  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
